...
export default function CurrentUser() {
    const { isLoading, data } = useFetch<User>(API_URL + "me", { headers: API_HEADERS });
...
Time Zone: ${data.time_zone}` : "";
    ...
    return <Detail isLoading={isLoading} markdown={markdown} actions={!data ? undefined : <ActionPanel>
